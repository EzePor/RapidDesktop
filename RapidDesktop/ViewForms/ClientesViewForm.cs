...
{
    public partial class ClientesViewForm : Form
    {
        ReportViewer reporte = new ReportViewer();
        RapidDesktopContext context = new RapidDesktopContext();
        public ClientesViewForm()
        {
            InitializeComponent();
        ...
        private void ClientesViewForm_Load(object sender, EventArgs e)
        {

            reporte.LocalReport.ReportEmbeddedResource = "RapidDesktop.Reportes.ClientesReport.rdlc";
